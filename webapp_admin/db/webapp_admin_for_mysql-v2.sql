...
-- ----------------------------
--  Table structure for `admin_attention`
-- ----------------------------
DROP TABLE IF EXISTS `admin_attention`;
CREATE TABLE `admin_attention` (
...
-- ----------------------------
--  Records of `admin_attention`
-- ----------------------------
BEGIN;
INSERT INTO `admin_attention` VALUES ('12', '4', '1', '2017-07-08 13:34:20'), ('13', '1', '4', '2017-07-08 13:38:05'), ('14', '1', '3', '2017-07-08 14:08:29'), ('15', '1', '2', '2017-07-08 14:08:33'), ('16', '1', '5', '2017-07-08 21:48:08'), ('17', '3', '1', '2017-07-09 09:31:00'), ('18', '1', '6', '2017-07-09 21:25:56'), ('19', '1', '7', '2017-07-09 21:31:58'), ('20', '2', '8', '2017-07-09 22:23:43'), ('21', '1', '9', '2017-07-09 23:18:52'), ('22', '1', '11', '2017-07-10 06:00:26'), ('23', '1', '10', '2017-07-10 06:00:34'), ('24', '1', '12', '2017-07-10 08:37:20'), ('25', '1', '13', '2017-07-10 12:00:23');
COMMIT;

-- ----------------------------
--  Table structure for `admin_friend_link`
-- ----------------------------
DROP TABLE IF EXISTS `admin_friend_link`;
CREATE TABLE `admin_friend_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_tip` VALUES ('1', 'A90198', '简书', '5', '2017-04-19 19:34:32'), ('2', '匿名网友', '微信', '5', '2017-04-21 15:53:34'), ('3', '匿名网友', '微信', '50', '2017-06-08 17:16:10'), ('4', '张向阳', '支付宝', '5', '2017-06-12 09:55:25'), ('5', '大志', '支付宝', '5', '2017-06-21 23:01:51');
COMMIT;
